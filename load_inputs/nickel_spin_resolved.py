...
e_dos_majo = np.loadtxt('inputs/Ni_spinResolved_eDOS_majority.txt')
e_dos_mino = np.loadtxt('inputs/Ni_spinResolved_eDOS_minority.txt')
...
file = open('inputs/Ni_spinResolved_eDOS_majority.txt')
alltext = file.read()
file.close()
...
eliashberg = np.loadtxt('inputs/Ni_spinResolved_EliashbergFunction_majorityAndMinority.txt') 
...
v_dos=np.loadtxt('inputs/Ni_spinResolved_vDOS.txt')
# convert energy from Hartree to eV
